"""Quick program to get student test scores from a google spreadsheet 
   Currently the list to select from comes back empty from topia.com, 
   but works over gmail.
